...
Copy-Item -Path "src\azure" -Destination "@microsoft.azure_autorest.csharp@2.3.84\node_modules\@microsoft.azure\autorest.csharp\src\azure" -Recurse
Copy-Item -Path "src\azurefluent" -Destination "@microsoft.azure_autorest.csharp@2.3.84\node_modules\@microsoft.azure\autorest.csharp\src\azurefluent" -Recurse
Copy-Item -Path "src\jsonrpc" -Destination "@microsoft.azure_autorest.csharp@2.3.84\node_modules\@microsoft.azure\autorest.csharp\src\jsonrpc" -Recurse
Copy-Item -Path "src\simplifier" -Destination "@microsoft.azure_autorest.csharp@2.3.84\node_modules\@microsoft.azure\autorest.csharp\src\simplifier" -Recurse
Copy-Item -Path "src\vanilla" -Destination "@microsoft.azure_autorest.csharp@2.3.84\node_modules\@microsoft.azure\autorest.csharp\src\vanilla" -Recurse
...
If (!(Test-Path "@microsoft.azure_autorest.csharp@2.3.84\node_modules\@microsoft.azure\autorest.csharp\src\bin\netcoreapp2.0\")) {
    New-Item -Path "@microsoft.azure_autorest.csharp@2.3.84\node_modules\@microsoft.azure\autorest.csharp\src\bin\netcoreapp2.0\" -ItemType Directory
}

Copy-Item -Path "published\*" -Destination "@microsoft.azure_autorest.csharp@2.3.84\node_modules\@microsoft.azure\autorest.csharp\src\bin\netcoreapp2.0\" -Recurse
